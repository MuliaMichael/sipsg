...
class AuthController extends Controller
{
    ...
    public function attemptRegister()
    {
        ...
        $rules = config('Validation')->registrationRules ?? [
            ...
            'firstname' => 'required|alpha_numeric_space|min_length[3]|max_length[30]|is_unique[users.firstname]',
            'lastname' => 'required|alpha_numeric_space|min_length[3]|max_length[30]|is_unique[users.lastname]',
